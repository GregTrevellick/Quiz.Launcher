    ...
    public class zQuestionsJeopardy_V1
    {
        public static IEnumerable<GatewayResponse> GetGatewayResponses()
        {
            var gatewayResponses = new List<GatewayResponse>
            {
                ...
                Get("Here it is in blue & white: the LaserJet Pro 400 printer from this brand?", "Hewlett-Packard ", "Todo1", "Todo2", "Todo3"),
                Get("The stars align with its Galaxy Note II phone?", "Samsung ", "Todo1", "Todo2", "Todo3"),
                Get("The Multi-Sport GPS watch is made by this company?", "TomTom  ", "Todo1", "Todo2", "Todo3"),
                ...
                Get("smugmug.com lets you share these & back them up pictures(or photographs)?", "analog", "Todo1", "Todo2", "Todo3"),//sdasdasdASDasdasasdasdasdas
                ...
                Get("On Feb. 29, 2008 Blu - Ray emerged as the new video disc choice as this Japanese co. abandoned its HD - DVD format Toshiba?", "analog", "Todo1", "Todo2", "Todo3"),//600 May 19,?", "analog", "Todo1", "Todo2", "Todo3"),//2008
                ...
                Get("On Oct. 15, 2003 it became the third country to launch a man into space; the Shenzhou 5 spacecraft orbited the Earth 14 times China?", "analog", "Todo1", "Todo2", "Todo3"),//200 March 15,?", "analog", "Todo1", "Todo2", "Todo3"),//2004
                ...
                Get("In 2008 an IBM supercomputer named for this speedy state bird broke the 1 petaflop barrier--that's really fast	a roadrunner	?","analog", "Todo1", "Todo2", "Todo3"),//200	September 21, 2011
