    ...
    public class QuestionsMine
    {
        public static IEnumerable<GatewayResponse> GetGatewayResponses()
        {
            var gatewayResponses = new List<GatewayResponse>
            {
                ...
                //Common.Get(DifficultyLevel.Medium,"What is Brainfuck?","A programming language","A term used by programmers to describe hard-to-fix bugs","Any code that can get into an infinite loop","Any bug that exists in a high level programming language's compiler", ""),
