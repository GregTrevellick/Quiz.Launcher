    ...
    public class QuestionsJeopardy
    {
        public static IEnumerable<GatewayResponse> GetGatewayResponses()
        {
            var gatewayResponses = new List<GatewayResponse>
            {
                ...
                Get("Time to process the Pentium 4 processor from this company?", "  Intel  ", "Todo1", "Todo2", "Todo3"),//200 April 23, 2014
                Get("CTR, the Computing-Tabulating-Recording Company, took on this current 3-letter name in 1924?", " IBM ", "Todo1", "Todo2", "Todo3"),//400 April 23, 2014
                Get("Here it is in blue & white: the LaserJet Pro?", "analog", "Todo1", "Todo2", "Todo3"),//400 printer from this brand?", "Hewlett-Packard ", "Todo1", "Todo2", "Todo3"),//600 April 23, 2014
                Get("The stars align with its Galaxy Note II phone?", "Samsung ", "Todo1", "Todo2", "Todo3"),//800 April 23, 2014
                Get("The Multi-Sport GPS watch is made by this company?", "TomTom  ", "Todo1", "Todo2", "Todo3"),//?","analog", "Todo1", "Todo2", "Todo3"),//1000    April 23, 2014

                ////http://jservice.io/popular/10511
                Get("This Apple product that was rolled out in 2010 has a 9.7-inch screen & is 1/2 inch thick?","     the iPad", "Todo1", "Todo2", "Todo3"),//200 March 4, 2011
                Get("Here you can clearly see the logo of this hi-def format for home theaters in 1080p?","   Blu - ray", "Todo1", "Todo2", "Todo3"),//400 March 4, 2011
                ...
                Get("Seen here is an icon for this 3 - letter service that feeds you updates on your favorite web sites?","     RSS", "Todo1", "Todo2", "Todo3"),//1000    March 4, 2011
                Get("For a great deal, check out this smallest version of the Apple iPod, even tinier than the Nano?","   the Shuffle", "Todo1", "Todo2", "Todo3"),//200 February 7,?", "analog", "Todo1", "Todo2", "Todo3"),//2007
                Get("Motorstorm, Lair & Warhawk are some of the products for this newest Sony entertainment system?", "  the PlayStation 3", "Todo1", "Todo2", "Todo3"),//400 February 7,?", "analog", "Todo1", "Todo2", "Todo3"),//2007
                ...
                Get("You don't need to go to this cell phone company's \"hotspot\" if you want to talk with your \"Sidekick\"?", "   T - Mobile", "Todo1", "Todo2", "Todo3"),//1000    February 7,?", "analog", "Todo1", "Todo2", "Todo3"),//2007
                ...
                Get("This photo co.created the EasyShare printer with prints that are less expensive &last?", "analog", "Todo1", "Todo2", "Todo3"),//100 years?", " Kodak", "Todo1", "Todo2", "Todo3"),//400 December 24,?", "analog", "Todo1", "Todo2", "Todo3"),//2008
                Get("In?", "analog", "Todo1", "Todo2", "Todo3"),//2008 lampposts in London were padded to prevent injuries due to this activity by pedestrians?", " texting", "Todo1", "Todo2", "Todo3"),//600 December 24,?", "analog", "Todo1", "Todo2", "Todo3"),//2008
                Get("To stop attackers from accessing your computer, in network settings, shut off the print sharing &this other \"sharing\"?", "  file sharing", "Todo1", "Todo2", "Todo3"),//800 December 24,?", "analog", "Todo1", "Todo2", "Todo3"),//2008
                Get("We can geek - up your computer by installing a printer, digital camera or any other external device, which is called this in computer speak, from the Greek for \"to carry around\"?", "     a peripheral", "Todo1", "Todo2", "Todo3"),//1000    December 24,?", "analog", "Todo1", "Todo2", "Todo3"),//2008

                ////http://jservice.io/popular/17308
                Get("Established in Mountain View in 1956, Shockley Semiconductor helped put this element in the name of a \"valley\"?", " silicon", "Todo1", "Todo2", "Todo3"),//200 February 10, 2014
                ...
                Get("Tony Hawk owns a Huntington Beach company that makes these pieces of sporting equipment?"," skateboards", "Todo1", "Todo2", "Todo3"),//600 February 10, 2014
                Get("Los Gatos is home to this 40-million member movie & TV streaming business?","   Netflix", "Todo1", "Todo2", "Todo3"),//800 February 10, 2014
                Get("Carlsbad's Callaway makes hi-tech these, like the FT Optiforce	?","golf clubs", "Todo1", "Todo2", "Todo3"),//	?","analog", "Todo1", "Todo2", "Todo3"),//1000	February 10, 2014

                ////http://jservice.io/popular/17737
                Get("hashtags.org tracks keywords on this social site that popularized the hashtag   Twitter?"," 	analog", "Todo1", "Todo2", "Todo3"),//200 October 2, 2013
                ...
                Get("In?", "analog", "Todo1", "Todo2", "Todo3"),//2007 President Bush said he'd do this "to the finish...that's one way to ensure that I am relevant"	sprint	?","analog", "Todo1", "Todo2", "Todo3"),//1000	June 16,?", "analog", "Todo1", "Todo2", "Todo3"),//2008
                ...
                Get("CSIRO has developed technology that helps drain this gas, CH4, released by the mining of coal   methane?", "analog", "Todo1", "Todo2", "Todo3"),//1000    June 5, 2013
                ...
                Get("These drone aircraft controlled from Nevada have been attacking targets in Pakistan Predator drones?", "analog", "Todo1", "Todo2", "Todo3"),//1000    February 19, 2010
                ...
                Get("The engine control unit, a car's smartest computer, monitors systems like injection of this	fuel	?","analog", "Todo1", "Todo2", "Todo3"),//1000	May 19,?", "analog", "Todo1", "Todo2", "Todo3"),//2008
                ...
                Get("This biologist first gained acclaim for writing in1937 with her article \"Undersea\" in the Atlantic Monthly  Rachel Carson ?", "analog", "Todo1", "Todo2", "Todo3"),//1000    October 1,?", "analog", "Todo1", "Todo2", "Todo3"),//2004
                ...
                Get("The tokamak, this type of nuclear reactor, uses plasma heated to 180 million degrees as fuel    fusion?", "analog", "Todo1", "Todo2", "Todo3"),//1000    March 15,?", "analog", "Todo1", "Todo2", "Todo3"),//2004
                ...
                Get("The Celsius temperature scale is also called this, meaning \"divided into one hundred parts\" centigrade?", "analog", "Todo1", "Todo2", "Todo3"),//1000    April 30,?", "analog", "Todo1", "Todo2", "Todo3"),//2002
                ...
                Get("The first modern ones of these, called Lucifers, were invented in 1827 & struck on sandpaper    Matches?",
"analog", "Todo1", "Todo2", "Todo3"),//200 January 31, 1996
                ...
                Get("A common way of linking computers in the office is this type of local area networking technology, which uses a Cat5 cable with a special connector   ethernet  ?", "analog", "Todo1", "Todo2", "Todo3"),//1000    June 1,?", "analog", "Todo1", "Todo2", "Todo3"),//2007
                ...
                Get("Put pulped cellulose fiber mixed with water & fillers into a Fourdrinier machine & it comes out as this paper ?", "analog", "Todo1", "Todo2", "Todo3"),//1000    April 11,?", "analog", "Todo1", "Todo2", "Todo3"),//2006
                ...
                Get("ASIMO, one of these, differentiates multiple voices using 8 microphones & Hark software a robot?", "analog", "Todo1", "Todo2", "Todo3"),//1000    April 8,?", "analog", "Todo1", "Todo2", "Todo3"),//2009
                ...
                Get("You'll hear it when making a season pass on this company's genius TV device TiVo  ?", "analog", "Todo1", "Todo2", "Todo3"),//1000    July 21,?", "analog", "Todo1", "Todo2", "Todo3"),//2005
                ...
                Get("With its Ofoto online service & Easyshare cameras, you'll never have to develop this company's film Kodak ?", "analog", "Todo1", "Todo2", "Todo3"),//1000    January 31,?", "analog", "Todo1", "Todo2", "Todo3"),//2005
                ...
                Get("Releasing someone's personal info on the Internet is this word that can have 1 or 2 \"X\"s in the middle	doxing (or doxxing)	?","analog", "Todo1", "Todo2", "Todo3"),//1000	March 12, 2015
                ...
                Get("Send me that report as a PDF, this \"format\" portable document format  ?", "analog", "Todo1", "Todo2", "Todo3"),//1000    February 19, 2013
                ...
                Get("imgur.com has a button to make this four-letter cultural reference that often spreads online a meme?", "analog", "Todo1", "Todo2", "Todo3"),//1000	July 29, 2014
                ...
                Get("The \"RT\" in \"RTOS\"  real-time ?", "analog", "Todo1", "Todo2", "Todo3"),//1000    April 4, 2014
                ...
                Get("The forerunner to the Internet known as the ARPANET was a 1960s network by this U.S. government dept.   Defense?", "analog", "Todo1", "Todo2", "Todo3"),//1000    February 17,?", "analog", "Todo1", "Todo2", "Todo3"),//2006
                ...
                Get("It can be a hiding place for food or treasure, or a place for memory on a computer's motherboard		?","a cache", "Todo1", "Todo2", "Todo3"),//1000	May 15,?", "analog", "Todo1", "Todo2", "Todo3"),//2006
                ...
                Get("On a monitor, 1280 x 1024 pixels is called \"native\" this, the degree of detail & sharpness  resolution?", "analog", "Todo1", "Todo2", "Todo3"),//1000    December 15,?", "analog", "Todo1", "Todo2", "Todo3"),//2005
                ...
                Get("In chat rooms, \"YMMV\" is this disclaimer often used in car ads; it basically lets you off the hook for anything you say your mileage may vary ?", "analog", "Todo1", "Todo2", "Todo3"),//1000    October 9,?", "analog", "Todo1", "Todo2", "Todo3"),//2006
                ...
                Get("A regional computer linker:LAN local area network?", "analog", "Todo1", "Todo2", "Todo3"),//1000    June 19,?", "analog", "Todo1", "Todo2", "Todo3"),//2009
                ...
                Get("In 1993 Intel introduced this new chip, which had 3.1 million transistors   Pentium?", "analog", "Todo1", "Todo2", "Todo3"),//1000    September 14,?", "analog", "Todo1", "Todo2", "Todo3"),//2006
                ...
                Get("\"DSL\" is \"digital\" this \"line\"  subscriber?", "analog", "Todo1", "Todo2", "Todo3"),//1000    November 27,?", "analog", "Todo1", "Todo2", "Todo3"),//2009
                ...
                Get("A swelling under the eye, or a quiet, timid person   ?", "  mouse", "Todo1", "Todo2", "Todo3"),//1000    June 22, 2011   
