    ...
    public class QuestionsMine
    {
        public static IEnumerable<GatewayResponse> GetGatewayResponses()
        {
            var gatewayResponses = new List<GatewayResponse>
            {
                ...
                Common.Get(DifficultyLevel.Hard, "What is the abbreviation GAC short for?",
                    "global assembly cache",
                    "general assembly cache",
                    "global action cache",
                    "general activity cache"),
                Common.Get(DifficultyLevel.Easy, "What is css short for?",
                    "cascading style sheets",
                    "cross site scripting",
                    "cascading script sheets",
                    "cascading style scripts",
                    "captain silly ship"),
                Common.Get(DifficultyLevel.Medium, "What is the abbreviation WSDL short for?",
                    "Web Services Description Language",
                    "Web Services Design Language",
                    "Web Services Description Log",
                    "Web Standards for Design Langauages"),
                Common.Get(DifficultyLevel.Medium, "What is the abbreviation SVG short for?",
                    "Scalable Vector Graphics",
                    "Standard Variable Graphics",
                    "Scalar Vector Graphic",
                    "Scalable Vector Graphs"),
                Common.Get(DifficultyLevel.Hard, "Where does the word \"Redis\" derived from?",
                    "REmote DIctionary Server",
                    "REadable DIctionary Server",
                    "REduced DIctionary Server",
                    "REplicated DIctionary Server"),
                Common.Get(DifficultyLevel.Medium, "What does the acronym XSS mean?",
                    "cross site scripting",
                    "cross site sequel",
                    "excess server store",
                    "extinct server store",
                    "ex-secret service"),
                Common.Get(DifficultyLevel.Easy, "What is the abbreviation SEO short for?",
                    "search engine optimization",
                    "senior executive officer",
                    "search engine organisation",
                    "senior executive order",
                    "small eggs omelette"),
                Common.Get(DifficultyLevel.Easy, "What is meant by the acronym DRY?",
                    "don't repeat yourself",
                    "do repeat yourself",
                    "dynamic real-time yourdon principle",
                    "Dry run your code"),
                Common.Get(DifficultyLevel.Hard, "What is XHR short for?",
                    "XML http object",
                    "cross http reader ",
                    "XML html object",
                    "cross html reader"),
                Common.Get(DifficultyLevel.Medium, "The Xerox Corporation helped create Javascript?",
                    "true",
                    "false"),
                Common.Get(DifficultyLevel.Easy, "What is an evergreen browser?",
                ...
                Common.Get(DifficultyLevel.Hard,
                    ...
                    "Segatron",
                    "Decathlon"),
                Common.Get(DifficultyLevel.Easy, "A white hat is?",
                ...
                Common.Get(DifficultyLevel.Medium, "What is the abbreviation SUT short for?",
                    "system under test",
                    "solution utilization tracker",
                    "system utilization tracker",
                    "system under trial",
                    "Suspected Underwear thief"),
                Common.Get(DifficultyLevel.Medium, "What is unobtrusive javascript?",
                ...
                Common.Get(DifficultyLevel.Medium, "What is the abbreviation SOA short for?",
                    "service oriented architecture",
                    "soap oriented architecture",
                    "systems oriented architecture",
                    "solutions oriented architecture",
                    "save our aragutans"),
                Common.Get(DifficultyLevel.Hard, "What is the acronym SOAP short for?",
                    "Simple Object Access Protocol",
                    "Service oriented architecture Protocol",
                    "Standard Object Accessor Pattern",
                    "Security Offensive Attack Principal",
                    "soap obscures all pongs"),
                Common.Get(DifficultyLevel.Hard, "What is the big-data related CAP theorem short for?",
                    "Consistency Availability Partition Tolerance",
                    "Consistency Availability Partition",
                    "Consistent Atomic Platform",
                    "Clone Available Pieces",
                    "climates and primates"),
                Common.Get(DifficultyLevel.Hard, "The data-related acronym ACID is short for?",
                ...
                Common.Get(DifficultyLevel.Hard, "What is the acronym REST short for?",
                    "REpresentational State Transfer",
                    "Really Easy Server Transport",
                    "Registry Extraction for System Testing",
                    "REgular Silent Transfers",
                    "a mars a day helps you work REST and play"),
                Common.Get(DifficultyLevel.Hard, "What was an original name for Babel",
                    "6 to 5",
                    "9 to 5",
                    "Tower.JS",
                    "JS.Tower",
