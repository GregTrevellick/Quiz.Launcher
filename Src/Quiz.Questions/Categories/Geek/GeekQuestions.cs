        ...
        public IEnumerable<QuizQuestion> GetGatewayResponses()
        {
            ...
            var gatewayResponses = new List<QuizQuestion>
            {
                ...
                Common.Get(Category.Geek, DifficultyLevel.Medium, "What is Layer 4 of the OSI Model?",
                    ...
                    "Session Layer",
                    "Presentation Layer"),
                Common.Get(Category.Geek, DifficultyLevel.Medium, "\"DOS\" stands for these 3 words?",
                ...
                Common.Get(Category.Geek, DifficultyLevel.Medium,
                    ...
                    "1024",
                    "zero"),
                Common.Get(Category.Geek, DifficultyLevel.Medium, "Send me that report as a PDF, this \"format\"?",
                    "portable document format",
                    "printable document format",
                    "published document format",
                    "protected document format"),
                Common.Get(Category.Geek, DifficultyLevel.Medium, "The 'S' in DSL is digital what line?",
                    "subscriber",
                    "service",
                    "speed",
                    "secure"),
                Common.Get(Category.Geek, DifficultyLevel.Medium, "What does LAN stand for?",
                    "local area network",
                    "linked area network",
                    "large area network",
                    "lost area network"), //, "lost all nerds"),
                Common.Get(Category.Geek, DifficultyLevel.Medium, "which digit number that means \"File Not Found\"?",
                    "404",
                    "201",
                    "501",
                ...
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "Android's 4.1 O.S.  called this?",
                //    "Jelly Bean",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "Coherant & Xenix are 2 of these, part of the abbreviation in the better-known MS-DOS?",
                //    "operating systems",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "Despite the name, the San Jose headquarters of this maker of the creative cloud isn't built of clay bricks	?",
                //    "Adobe	",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "Device that stealth aircraft technology is designed to trick?",
                //    "radar",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "Dioxide of this element, symbol Cr, is used to make recording tape for cassettes?",
                //    "chromium",
                //    "magnet",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "Established in Mountain View in 1956, Shockley Semiconductor helped put this element in the name of a \"valley\"?",
                //    "silicon",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "First built in 1960, it's also been called an optical maser?",
                //    "laser",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "GOES, INSAT & METEOSAT are satellites used for this purpose?",
                //    "Weather Forecasting",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "Hubert Booth, not Herbert Hoover, developed the first practical electric one of these in 1901?",
                //    "Vacuum cleaner",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "imgur.com has a button to make this four-letter cultural reference that often spreads online?",
                //    "a meme",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "In 1960 Theodore Maiman used this gem in his laser?",
                //    "Ruby",
                //    "diamond",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "In 1983 Apple's Lisa computer gave PCs this device that moves the cursor around the screen	?",
                //    "mouse",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "In 1993 Intel introduced this new chip, which had 3.1 million transistors?",
                //    "Pentium",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "In 1995 Wells Fargo became the first bank whose customers could securely view their accounts here?",
                //    "online",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "In 2014 Facebook agreed to pay $2 billion for Oculus, a maker of this immersive technology?",
                //    "virtual reality	",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "In chat rooms, \"YMMV\" is this disclaimer often used in car ads; it basically lets you off the hook for anything you say?",
                //    "your mileage may vary",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "In the abbreviation JPEG, the \"P\" is this 12 - letter adjective?",
                //    "Photographic",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "It's a measure of speed:BPS?",
                //    "bytes per second",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "It's the brains of the operation:CPU?",
                //    "central processing unit",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "On August 12, 1981 the world saw the first IBM personal computer using this Microsoft operating system?",
                //    "MS-DOS",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "On Feb. 17, 2009 this type of TV broadcast technology will end in the U.S.; we're going digital?",
                //    "analog",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "On Feb. 29, 2008 Blu - Ray emerged as the new video disc choice as this Japanese co. abandoned its HD - DVD format?",
                //    "Toshiba",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "Reddit is known for hosting online interviews where you can AMA, short for this?",
                //    "ask me anything",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "Seen here is an icon for this 3 - letter service that feeds you updates on your favorite web sites?",
                //    "RSS",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "smugmug.com lets you share these & back them up?",
                //    "pictures(or photographs)",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "The \"G\" in .gif & .png stands for these?",
                //    "graphics",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "The \"HT\" in both HTTP & HTML stands for this?",
                //    "hypertext",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "The \"P\" in jpeg?",
                //    "photographic",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "What does RAID stand for?",
                //    "redundant array of inexpensive disks",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "A type of hacker who ethically reports security problems is called this, a proverbial accessory of cowboy heroes?",
                //    "white hat",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "Automaton is sometimes just a fancy name for one of these mechanical beings?",
                //    "a robot",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "what was ASIMO?",
                //    "a robot that differentiates multiple voices using 8 microphones & Hark software?",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "In 1991 Apple introduced this media player//would you like to download the latest version?",
                //    "QuickTime",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "The \"B\" in COBOL?",
                //    "business",
                //    "binary",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "The \"D\" in a DoS attack?",
                //    "denial",
                //    "distributed",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "The \"RT\" in \"RTOS\"?",
                //    "real-time",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "Cesium was the first element found by this process using the band of colored light produced by a prism?",
                //    "Spectroscopy",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "The forerunner to the Internet known as the ARPANET was a 1960s network by this U.S. government dept.?",
                //    "Defense",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "The IBM \"computer\" of 1928 stored its data on these?",
                //    "Punch cards",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "The Nomad Jukebox Zen Xtra is a device which plays music in this alphanumeric format?",
                //    "MP3",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "The ROM of your computer's CD-ROM stands for this?",
                //    "read-only memory",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "The second \"T\" in HTTP?",
                //    "transfer or transport",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "The smallest units of information stored in a computer, they form bytes?",
                //    "bits",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "Thinking Machines Corp.pioneered this processing// as the geometric name indicates, many processors work side by side?",
                //    "parallel processing",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "This 4-letter word is \"warm\" when the computer's power is already on, \"cold\" when it's off?",
                //    "boot",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "This Apple product that was rolled out in 2010 has a 9.7-inch screen & is 1/2 inch thick?",
                //    "the iPad",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "This chipmaker, the world's largest, has announced \"systems on a chip\" measuring 22 nanometers?",
                //    "Intel	",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "This company whose name is synonymous with copying introduced the first hand - held mouse in 1973?",
                //    "Xerox",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "This computer device slowly takes you online?",
                //    "a modem",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "This computer was introduced in 1984 & came with a MacWrite text program & a MacPaint program for graphics?",
                //    "Apple Macintosh",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "This photo co.created the EasyShare printer with prints that are less expensive &last 100 years?",
                //    "Kodak",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "This popular Internet service provider began as QCS, Quantum Computer Services?",
                //    "AOL(America Online)",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "This process that maximizes disk space is so named because it joins up pieces of files that were stored separately?",
                //    "defrag (or defragmenting)	",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "This programming language was named for calculating - machine inventor Blaise?",
                //    "PASCAL",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "This removable item used for data storage was introduced in 1971; the first one was 8 inches square?",
                //    "floppy disk",
                //    "compact disc",
                //    "flash drive",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "This type of \"net\" developed by Xerox has helped local area networks communicate since the 1970s?",
                //    "ethernet",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "Useful for connecting devices, USB is short for Universal Serial this?",
                //    "Bus",
                //    "button",
                //    "bytes",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "We can geek - up your computer by installing a printer, digital camera or any other external device, which is called this in computer speak, from the Greek for \"to carry around\"?",
                //    "a peripheral",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "We're gonna go old school and use keyboard characters to translate my image into this computing code?",
                //    "ASCII",
                //    "Todo1",
                //    "Todo2",
                //    "Todo3"),
                //Common.Get(Category.Geek, DifficultyLevel.Medium, "When a device can be attached to your computer & install itself, it's PnP, short for this?",
                //    "Plug and Play",
                //    "push and pull",
                //    "todo2",
                //    "Todo3"),
