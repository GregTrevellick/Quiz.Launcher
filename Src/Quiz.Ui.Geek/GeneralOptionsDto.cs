...
namespace Quiz.Ui
{
    public class GeneralOptionsDto : HiddenOptionsDto
    {
        ...
        public bool IncludeQuizCategoryFrontEnd { get; set; }
        ...
        public GeekCategory PreferredGeekCategoriesFromOptions
        {
            get
            {
                ...
                preferredGeekCategoriesFromOptions |= IncludeQuizCategoryFrontEnd ? GeekCategory.FrontEnd : GeekCategory.Unknown;
